            ...
            <div class="card-body">
                ...
                <form action="" method="post" name="form1">
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            <select class="form-control" id="khachhang" name="khachhang_id" style="width: 30rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="note" style="width: 30rem;">
                    </div>
                    <div class="form-group">
                        <label for="">Tiền thu hộ</label>
                        <input class="form-control" type="text" name="tien" style="width: 30rem;">
                    </div>
                    ...
                    if(isset($_POST['submitOrder'])) {	
                        ...
                        // checking empty fields
                        $result1 = mysqli_query($mysqli, "INSERT INTO donhang(loaihang_id,khach_id,note,tien,hinhthuc) VALUES($loaihang_id,$khachhang_id,'$note',$tien,$hinhthuc)");
