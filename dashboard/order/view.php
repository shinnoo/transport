                        ...
                        <div class="dropdown-menu" aria-labelledby="language">
                            ...
                            <div class="dropdown-item">
                                <i class="flag-icon flag-icon-it"></i>
                                    ...
                                    <!-- $khachhang_id = $res['khachhang_id'];
                                $loaihang_id = $res['loaihang_id'];
        ...
        ?>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập họ tên" name="name"
                            value="<?php echo $name;?>" style="width: 30rem;">
                    </div>
                    <div class="form-group">
                        <label>Số điện thoại</label>
                        <input type="text" class="form-control" name="sdt" value="<?php echo $sdt;?>"style="width: 30rem;">
                    </div>
                    <div class="form-group">
                        <label>Địa chỉ</label>
                        <input type="text" class="form-control" name="diachi" value="<?php echo $diachi;?>"style="width: 30rem;">
                    </div>

                    <div class="form-group">
                        <label for="">Loại hàng hóa</label>
                        <input type="text" class="form-control" name="tenhang" value="<?php echo $tenhang;?>"style="width: 30rem;">
                    </div>
                    <div class="form-group">
                        <label for="">Hình thức vận chuyển</label>
                        <input type="text" class="form-control" name="hinhthuc" value="<?php if($hinhthuc == 1){echo 'Giao hàng nhanh';} else echo 'Giao hàng tiêu chuẩn'?>"style="width: 30rem;">
                    </div>
                    <div class="form-group">
                        <label for="">Ghi chú</label>
                        <input class="form-control" type="text" name="note" value="<?php echo $note;?> "style="width: 30rem;">
                    </div>
                    <div class="form-group">
                        <label for="">Tiền thu hộ</label>
                        <input class="form-control" type="text" name="tien" value="<?php echo $tien;?> "style="width: 30rem;">
                    </div>
